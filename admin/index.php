  ...
  <div class="row">
    <div class="col-md-2">
      <div class="list-group">
        ...
        <a href="index.php?page=product" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> PRODUCTS</a>
        <a href="index.php?page=supplies" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> SUPPLIES</a>
        <a href="index.php?page=stock" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> STOCKS</a>
        <a href="index.php?page=request" class="list-group-item list-group-item-action"><i class="fa fa-user"></i> STOCK REQUESTS</a>
        <a href="index.php?page=suppliers" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i>SUPPLIERS</a>
        ...
        <a href="index.php?page=all-users" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> USERS</a>
