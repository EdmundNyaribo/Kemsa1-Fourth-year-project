...
$sql = "SELECT * FROM purchases where client_name = '$name' AND pay_status != 'Success' ";
                            ...
                            ?>
                                    ...
                                    <?php if ($row["pay_status"] != 'Success') : ?>
                                        ...
                                        <td><button class='btn btn-success' style=\"background-color:white;\">
                                                <a href='payment.php?uid=$id'> MakePayment /Remove</a> </button></td>"
                                        ?>
                                    <?php endif ?>
